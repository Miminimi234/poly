...
export default function Footer() {
  return (
    <footer className="relative z-10 w-full border-t border-neutral-200 dark:border-neutral-800 /80 dark:bg-neutral-950/80 backdrop-blur-xl">
      <div className="container mx-auto px-4 md:px-6 py-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              href="https://twitter.com/Polysentience"
              target="_blank"
            ...
            <Link
              href="https://github.com/Polysentience"
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors"
            >
