                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border-2 border-black px-4 py-3 text-sm font-bold bg-white focus:outline-none focus:ring-2 focus:ring-black"
                                    required
                                    disabled={isLoading}
                                />
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="w-full border-2 border-black px-4 py-3 font-bold bg-black text-white hover:bg-gray-800 disabled:opacity-50 text-sm"
                                style={{ boxShadow: '4px 4px 0px rgba(0,0,0,0.3)' }}
                            >
