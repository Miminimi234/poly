    ...
    <div className="min-h-screen  text-black">
      ...
      <div className="relative z-10 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-black-600 research-subtitle">
        ...
        <div className=" border-1 border-gray p-6 mb-8"
          ...
          <p className="text-xs text-black-700 mb-3">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-xs">
            <div className="bg-white border-2 border-gray p-3">
              <div className="font-bold mb-1">STEP 1</div>
              <div className="text-black-700">Agent decides research is needed</div>
            </div>
            <div className="bg-white border-2 border-gray p-3">
              <div className="font-bold mb-1">STEP 2</div>
              <div className="text-black-700">Payment made via Solana wallet</div>
            </div>
            <div className="bg-white border-2 border-gray p-3">
              <div className="font-bold mb-1">STEP 3</div>
              <div className="text-black-700">Data received and analyzed</div>
            </div>
          </div>
        </div>
          ...
          {resources.map(resource => (
            <div key={resource.id}
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <span className="text-xs uppercase px-2 py-1 border-2 border-gray bg-white">
              ...
              {/* Description */}
              <p className="text-xs text-black-700 mb-4">
              ...
              <div className="grid grid-cols-2 gap-3 mb-4 text-xs">
                <div>
                  <div className="text-black-600 mb-1">TYPE</div>
                  <div className="font-bold uppercase">{resource.type}</div>
                </div>
                <div>
                  <div className="text-black-600 mb-1">FRESHNESS</div>
        ...
        {/* Footer Info */}
        <div className="mt-8 bg-white border-2 border-gray p-6">
