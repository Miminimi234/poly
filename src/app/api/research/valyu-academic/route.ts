/**
 * -enabled Valyu Academic Papers API
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log(`[-ValyuAcademic] Executing academic search for agent ${paymentRequest.agentId}: "${query}"`);
    ...
    console.log(`[-ValyuAcademic] Payment successful for agent ${paymentRequest.agentId}. Results: ${searchResult.results.length}, Cost: $${searchResult.totalCost}`);
    ...
    console.error('[-ValyuAcademic] Error:', error);
    return NextResponse.json(
      {
